...
export rand, randomise
export StartMixture, AbstractGenomeDist
...
"""
function permtest(
	col1::GenomicFeatures.IntervalCollection, 
	col2::GenomicFeatures.IntervalCollection, 
	regions::GenomicFeatures.IntervalCollection, 
	iterations::Int, 
	f::Function = GenomePermutations.dist;
	bed_names::Tuple = (nothing,nothing), allow_overlap::Bool = false, max_tries::Int = 1000, onfail::Symbol = :throw
)
